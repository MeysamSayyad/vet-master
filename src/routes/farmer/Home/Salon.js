...
<div className="">
  <div className='flex  '>
    <div className=" border-slate-400 w-90 min-h-[90vh] ">
      <button className='text-slate-500 text-xs lg:text-base lg:bold font-semibold border-[1.5px] border-slate-500 p-2 lg:px-6 px-1 mb-1  hover:bg-slate-500 transition-all hover:text-white rounded 'onClick={data.length>0?creact:()=>setshow(true)}> افزودن دوره پرورش </button> <br />
      {
        data.length === 0 ? <h2 className="lg:text-lg text-base my-3">هنوز دوره پرورشی وجود ندارد</h2>:
